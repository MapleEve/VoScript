...
This is the public configuration index for VoScript v0.8.0. It covers the
...
`MODELS_DIR` and `LANGUAGE` are defined in the config module, but v0.8.0's main
...
These do not have env or API fields in v0.8.0. Do not configure nonexistent
...
v0.8.0 defaults to `DENOISE_MODEL=none` for clean meeting-recorder audio. Enable
...
- v0.8.0 protects larger loaded or persisted cohorts during automatic rebuilds:
