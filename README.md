...
v0.8.0 公开默认值面向干净会议录音：`DENOISE_MODEL=none`、
...
- 带时间戳的逐字稿，每个词都精确对齐
- 真名说话人标签（没登记过的保留原始 `SPEAKER_XX` 标签）
- 支持中文、英文等多语言混录
...
| AI 代理技能包 | [voscript-skills](https://github.com/MapleEve/voscript-skills) | [voscript-skills](https://github.com/MapleEve/voscript-skills) |
